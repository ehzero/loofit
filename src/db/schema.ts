...
export {
  ...
  DATABASE_VERSION,
  MIGRATION_SQL,
  SCHEMA_MIGRATION_FIXTURE_SQL,
  SINGLE_ACTIVE_SESSION_INVARIANT_SQL,
  WIDGET_SYNC_OPERATIONS,
  WIDGET_SYNC_STATE_BOOTSTRAP_SQL,
  WIDGET_SYNC_STATE_TABLE,
  WIDGET_SYNC_TRACKED_TABLES,
